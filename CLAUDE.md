...
| Layer | Technology |
|-------|-----------|
| Frontend | React 19, TypeScript, Vite 7, Tailwind CSS 4, shadcn/ui (Radix) |
...
├── frontend/                  # React SPA
│   └── src/
│       ├── components/        # Reusable components (ui/, layout/, activity/, documents/, whatsapp/)
│       ├── pages/             # Page components (Dashboard, Leads, Clients, Cases, etc.)
│       ├── hooks/             # Custom React Query hooks (useLeads, useClients, useCases, etc.)
│       ├── types/             # TypeScript type definitions
│       ├── lib/               # Utilities (api.ts, formatters.ts, toastMessages.ts)
